...
package com.example.miguel.basicvuforia.SampleApplication;
...
public class SampleApplicationSession implements UpdateCallbackInterface
{
    ...
    public void startAR(int camera) throws SampleApplicationException
    {
        ...
        //MIG: Ponemos el formato de la imagen para poder tratarla luego en MainActivity
    ...
    {
   //     Log.d(LOGTAG, "Miguel: llega aqui");
        // Vuforia-specific resume operation
        Vuforia.onResume();
   //     Log.d(LOGTAG, "Miguel: pero no llega aqui");
        if (mStarted)
        {
            startAR(mCamera);
        }
    ...
    private class InitVuforiaTask extends AsyncTask<Void, Integer, Boolean>
    {
        ...
        protected Boolean doInBackground(Void... params)
        {
            ...
            synchronized (mShutdownLock)
            {
                Vuforia.setInitParameters(mActivity, mVuforiaFlags, "");
