...
import com.example.miguel.basicvuforia.SampleApplication.utils.CubeShaders;
import com.example.miguel.basicvuforia.SampleApplication.utils.SampleUtils;
...
public class FrameMarkerRenderer implements GLSurfaceView.Renderer
{
   ...
   //Estos son los objetos ejemplos
   ...
   public FrameMarkerRenderer(MainActivity activity,
                              SampleApplicationSession session)
    {
        mActivity = activity;
    ...
    void renderFrame()
    {
        ...
        {
            Log.d(LOGTAG, "Miguel: Encontramos una tracker");
            // Get the trackable:
